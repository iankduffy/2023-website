    ...
    <header className='relative py-4'>
      <div className='container flex items-center justify-between gap-5 px-3 py-5 mx-auto text-white lg:py-0'>
        ...
        <div className="flex gap-2 lg:gap-5 text-large items-center">
          {linkedin && <Link href={linkedin} target='_blank' className='h-full py-2 text-2xl' aria-label='Linkedin'><FaLinkedin /><span className='hidden'>Linkedin</span></Link>}
          {github && <Link href={github} target='_blank' className='h-full py-2 text-2xl' aria-label='github'><FaGithub /><span className='hidden'>Github</span></Link>}
